...
def trend_sell_signal(trend, hunter_settings):
    ...
    Args:
        ...
        hunter_settings (object): The bot settings containing trend signal preferences.
...
@exception_handler(default_return=False)
def rsi_sell_signal(latest_data, hunter_settings):
    """
    ...
    Args:
        ...
        hunter_settings (object): The bot settings containing RSI sell signal preferences.
...
@exception_handler(default_return=False)
def rsi_divergence_sell_signal(latest_data, averages, hunter_settings):
    """
    ...
    Args:
        ...
        hunter_settings (object): The bot settings containing RSI divergence signal preferences.
...
@exception_handler(default_return=False)
def macd_cross_sell_signal(latest_data, previous_data, hunter_settings):
    """
    ...
    Args:
        ...
        hunter_settings (object): The bot settings containing MACD crossover signal preferences.
...
@exception_handler(default_return=False)
def macd_histogram_sell_signal(latest_data, previous_data, hunter_settings):
    """
    ...
    Args:
        ...
        hunter_settings (object): The bot settings containing MACD histogram signal preferences.
...
@exception_handler(default_return=False)
def bollinger_sell_signal(latest_data, hunter_settings):
    """
    ...
    Args:
        ...
        hunter_settings (object): The bot settings containing Bollinger Bands signal preferences.
...
@exception_handler(default_return=False)
def stoch_sell_signal(latest_data, previous_data, hunter_settings):
    """
    ...
    Args:
        ...
        hunter_settings (object): The bot settings containing Stochastic signal preferences.
...
@exception_handler(default_return=False)
def stoch_divergence_sell_signal(latest_data, averages, hunter_settings):
    """
    ...
    Args:
        ...
        averages (dict): The average market data for comparison.
        hunter_settings (object): The bot settings containing Stochastic divergence signal preferences.
...
@exception_handler(default_return=False)
def stoch_rsi_sell_signal(latest_data, hunter_settings):
    """
    ...
    Args:
        ...
        hunter_settings (object): The bot settings containing Stochastic RSI signal preferences.
...
@exception_handler(default_return=False)
def ema_cross_sell_signal(latest_data, previous_data, hunter_settings):
    """
    ...
    Args:
        ...
        hunter_settings (object): The bot settings containing EMA crossover signal preferences.
...
@exception_handler(default_return=False)
def ema_fast_sell_signal(latest_data, hunter_settings):
    """
    ...
    Args:
        ...
        hunter_settings (object): The bot settings containing the fast EMA signal preferences.
...
@exception_handler(default_return=False)
def ema_slow_sell_signal(latest_data, hunter_settings):
    """
    ...
    Args:
        ...
        hunter_settings (object): The bot settings containing the slow EMA signal preferences.
...
@exception_handler(default_return=False)
def di_cross_sell_signal(latest_data, previous_data, hunter_settings):
    """
    ...
    Args:
        ...
        hunter_settings (object): The bot settings containing DI crossover signal preferences.
...
@exception_handler(default_return=False)
def cci_sell_signal(latest_data, hunter_settings):
    """
    ...
    Args:
        ...
        hunter_settings (object): The bot settings containing CCI sell signal preferences.
...
def cci_divergence_buy_signal(latest_data, averages, hunter_settings):
    ...
    Args:
        ...
        averages (dict): The average market data for comparison.
        hunter_settings (object): The bot settings containing CCI divergence signal preferences.
...
@exception_handler(default_return=False)
def mfi_sell_signal(latest_data, hunter_settings):
    """
    ...
    Args:
        ...
        hunter_settings (object): The bot settings containing MFI sell signal preferences.
...
@exception_handler(default_return=False)
def mfi_divergence_sell_signal(latest_data, averages, hunter_settings):
    """
    ...
    Args:
        ...
        averages (dict): The average market data for comparison.
        hunter_settings (object): The bot settings containing MFI divergence signal preferences.
...
@exception_handler(default_return=False)
def atr_sell_signal(latest_data, averages, hunter_settings):
    """
    ...
    Args:
        ...
        averages (dict): The average market data for comparison.
        hunter_settings (object): The bot settings containing ATR signal preferences.
...
@exception_handler(default_return=False)
def vwap_sell_signal(latest_data, hunter_settings):
    """
    ...
    Args:
        ...
        hunter_settings (object): The bot settings containing VWAP signal preferences.
...
@exception_handler(default_return=False)
def psar_sell_signal(latest_data, hunter_settings):
    """
    ...
    Args:
        ...
        hunter_settings (object): The bot settings containing PSAR signal preferences.
...
@exception_handler(default_return=False)
def ma50_sell_signal(latest_data, hunter_settings):
    """
    ...
    Args:
        ...
        hunter_settings (object): The bot settings containing MA50 signal preferences.
...
@exception_handler(default_return=False)
def ma200_sell_signal(latest_data, hunter_settings):
    """
    ...
    Args:
        ...
        hunter_settings (object): The bot settings containing MA200 signal preferences.
...
@exception_handler(default_return=False)
def ma_cross_sell_signal(latest_data, previous_data, hunter_settings):
    """
    ...
    Args:
        ...
        hunter_settings (object): The bot settings containing MA crossover signal preferences.
...
def check_classic_ta_sell_signal(
    ...
    Args:
        ...
        hunter_settings (object): The bot settings containing preferences for each technical signal.
    ...
    sell_signals = [
        ...
        rsi_divergence_sell_signal(latest_data, averages, hunter_settings),
        macd_cross_sell_signal(latest_data, previous_data, hunter_settings),
        macd_histogram_sell_signal(latest_data, previous_data, hunter_settings),
        bollinger_sell_signal(latest_data, hunter_settings),
        stoch_sell_signal(latest_data, previous_data, hunter_settings),
        stoch_divergence_sell_signal(latest_data, averages, hunter_settings),
        stoch_rsi_sell_signal(latest_data, hunter_settings),
        ema_cross_sell_signal(latest_data, previous_data, hunter_settings),
        ema_fast_sell_signal(latest_data, hunter_settings),
        ema_slow_sell_signal(latest_data, hunter_settings),
        di_cross_sell_signal(latest_data, previous_data, hunter_settings),
        cci_sell_signal(latest_data, hunter_settings),
        cci_divergence_buy_signal(latest_data, averages, hunter_settings),
        mfi_sell_signal(latest_data, hunter_settings),
        mfi_divergence_sell_signal(latest_data, averages, hunter_settings),
        atr_sell_signal(latest_data, averages, hunter_settings),
        vwap_sell_signal(latest_data, hunter_settings),
