...
class TestExceptionHandler(unittest.TestCase):
    ...
    def test_function_with_index_error(self, mock_send_email, mock_logger):
        ...
        self.assertIn("IndexError in function_with_index_error", [call[0][0] for call in mock_send_email.call_args_list])
    ...
    def test_function_with_unhandled_exception(self, mock_send_email, mock_logger):
        ...
        self.assertEqual(result, "Fallback value")
        mock_send_email.assert_called_once()
        self.assertIn("Exception in function_with_unhandled_exception", [call[0][0] for call in mock_send_email.call_args_list])
        mock_logger.error.assert_called_once()
    ...
    def test_function_with_exit(self, mock_exit, mock_send_email, mock_logger):
        ...
        mock_send_email.assert_called_once()
        self.assertIn("IndexError in function_with_exit", [call[0][0] for call in mock_send_email.call_args_list])
    ...
    def test_function_with_callable_default_return(self, mock_send_email, mock_logger):
        ...
        mock_send_email.assert_called_once()
        self.assertIn("IndexError in function_with_callable", [call[0][0] for call in mock_send_email.call_args_list])
